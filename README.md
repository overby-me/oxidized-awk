...
> [`safety/oxidized/awk`](https://tangled.org/overby.me/overby.me/tree/main/safety/oxidized/awk) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/oxidized-awk](https://tangled.org/overby.me/oxidized-awk) and
> [github.com/overby-me/oxidized-awk](https://github.com/overby-me/oxidized-awk). Both
