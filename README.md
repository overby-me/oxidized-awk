...
> [`safety/oxidized/awk`](https://tangled.org/overby.me/overby.me/tree/main/rust/awk) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/rust-awk](https://tangled.org/overby.me/rust-awk) and
> [github.com/overby-me/rust-awk](https://github.com/overby-me/rust-awk). Both
